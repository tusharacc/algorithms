...
class TestSelSortFunction(unittest.TestCase):
	...
	def test_1(self):
		sequence = [5,4,3,2,1]
		self.assertEqual(initiate_quick_sort(sequence),[1,2,3,4,5])
	...
	def test_3(self):
		...
		self.assertEqual(initiate_quick_sort(sequence),[1,2,2,5,5])  
	...
	def test_random_list(self):
		...
		self.assertEqual(initiate_quick_sort(list_of_items),sorted_list)
